      ...
      request({url : url, json: true}, (error,{body}) => {
           ...
           if (error) {
             ...
             callback('unable to find location! please enter proper values of longitude and latitude...and try again',undefined)
               ...
               callback(undefined,`${body.daily.data[0].summary} It is currently ${body.currently.temperature} degrees out today. There is ${body.currently.precipProbability}% chance of rain.` )
           }
